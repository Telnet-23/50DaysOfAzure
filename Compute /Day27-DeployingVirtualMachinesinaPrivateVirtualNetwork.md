...
I made an NSG called nautilus-priv-nsg in the East US region then configuired it to allow inbound SSH traffic on port 22 from 10.0.0.0/16 and applied it to the NIC on my VM. 
